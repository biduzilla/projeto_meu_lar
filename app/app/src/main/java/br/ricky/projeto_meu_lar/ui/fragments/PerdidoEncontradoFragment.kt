 ...
 * Use the [PerdidoEncontradoFragment.newInstance] factory method to
...
class PerdidoEncontradoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PerdidoEncontradoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PerdidoEncontradoFragment().apply {
